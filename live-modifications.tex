...
\file{$\sim$/.mozilla/firefox/\$something.default/bookmarks.html}, where
\$something is a randomly generated string) to \file{/etc/firefox/profile} in
the SquashFS.
...
08/2006, \cmd{pngtobogl} created a buggy file where all the first (0) and second
...
To get the live-CD use the new image it is necessary to unpack the inital
